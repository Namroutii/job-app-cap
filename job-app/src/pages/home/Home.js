...
function Home() {
  return (
    <div>
      ...
      <div className='col-12 col-md-10 col-lg-6 col-xl-4 col-xxl-3'>
      ...
      <Services imag="./images/cv.jpg" info="Add CV" paragraph="Employees can submit a CV with ease by adding the necessary
