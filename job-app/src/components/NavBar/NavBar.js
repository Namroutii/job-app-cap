            ...
            <nav className="navbar-dark navbar navbar-expand-lg fixed-top">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <Link className="dropdown-item" to="/add-cv"> Add Cvs</Link>
                                    </li>
                                    <li>
                                        <Link className="dropdown-item" to="/get-cv">Show Cvs</Link>
                                    </li>
                                    <li>
                                        <a className="dropdown-item" href="#services">About Our Services</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <Link className="nav-login" to="/login" ><span className="login">Login</span></Link>
                    </div>
                </div>
            </nav>
    );
