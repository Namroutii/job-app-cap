    ...
    <section className="cards" id="services">
      ...
      <div className="content">
        <Link to="/get-cv" className="services-links">
          <div className="card">
            ...
            <div className="info">
              ...
              <p>
                Companies struggle to locate employees,so we are in HireMe we
        ...
        <Link to="/get-cv" className="services-links">
          <div className="card">
            <div className="imag">
              <img src="./images/Filter.jpg" alt="..."></img>
            </div>
            <div className="info">
              <h2>Filter</h2>
              <p>
                When reviewing resumes, it might be challenging to find the
                ...
                you'll find everything you need to hire the ideal candidate.
              </p>
            </div>
          </div>
        </Link>
        <Link to="/add-cv" className="services-links">
          <div className="card">
            ...
            <div className="info">
              <h2>Add CV</h2>
              <p>
                Employees can submit a CV with ease by adding the necessary
                ...
                will make it before attaching the CV.
              </p>
            </div>
          </div>
        </Link>
